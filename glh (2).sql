...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 14, 2026 at 01:25 PM
...
(3, 'Beef chunks', 21, 13.00, 'Ranch owned beef chunks', 'https://www.lovefoodhatewaste.com/sites/default/files/styles/16_9_two_column/public/2022-08/Beef-sh344681603.jpg.webp?itok=qenlRZUs', 'beef', 9),
(4, 'Button mushrooms', 59, 2.00, 'Local sourced button mushrooms', 'https://www.out-grow.com/cdn/shop/articles/white_button_1c178a8e-b1fe-4f7e-9a80-e9b6fc7ed0da_1200x1200.jpg?v=1743447040', 'fungi', 10),
(5, 'Salmon chunks', 23, 6.00, 'Local harvested salmon chunks', 'https://therockfish.co.uk/cdn/shop/files/Glenarm-salmon-portion-rockfish.jpg?v=1758640154&width=1200', 'fish', 10);
...
--
ALTER TABLE `order_items`
  MODIFY `Order_itemsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
