...
<div class="container signbox">
    ...
    <div class="mb-3">
        ...
        if (isset($_SESSION["customer"])) {
            ?>
        <input type="int" class="form-control" id="phonenumber" value="<?php echo $_SESSION['customer']['PhoneNumber'] ?>">
        <?php
        } else {
            ?>
        <input type="int" class="form-control" id="phonenumber" placeholder="Enter your phone number" name="phonenumber">
        <?php } ?>
    </div>
    <div class="mb-3">
